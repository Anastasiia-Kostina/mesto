...
const popupCloseBtnEditProfile = document.querySelector(".popup__close-button-edit");
const popupFormSubmitEditProfile = document.querySelector(".popup__form_edit-profile");
...
const picGalleryCardTemplate = document.querySelector(".pic-gallery__cards-template").content; //Couldn't find the right way to change it
//------------create const end------------------------
